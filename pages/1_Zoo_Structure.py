...
icons = [':tiger:',':monkey:',':gorilla:',':orangutan:',':leopard:',':flamingo:',':seal:']
...
st.markdown(f"{icons[0]}{icons[1]}{icons[2]}{icons[3]}{icons[4]}{icons[5]}{icons[6]}")
...
st.markdown("""
The Zoo employs :red[Staff]. Roughly 70% of staff are full time, the rest are part time. Each Zone has a dedicated Vet, 
            a Supervisor, and 6 staff.
